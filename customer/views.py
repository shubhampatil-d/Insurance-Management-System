...
from insurance.models import Category  # Adjust import if needed
...
def customer_view_category_view(request):
    categories = Category.objects.all()
    return render(request, 'customer/customer_view_category.html', {'categories': categories})
